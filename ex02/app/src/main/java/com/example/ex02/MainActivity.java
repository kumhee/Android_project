...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //데이터 생성
        array = new ArrayList<>();
        ProductVO vo = new ProductVO(1, "삼성 비스코프 냉장고", R.drawable.b02, 4500000);
        array.add(vo);
        vo = new ProductVO(2, "엘지 오브제 세탁기", R.drawable.b03, 3500000);
        array.add(vo);
        vo = new ProductVO(3, "엘지 오브제 건조기", R.drawable.b04, 3500000);
        array.add(vo);
        vo = new ProductVO(4, "삼성 비스코프 TV", R.drawable.b05, 2500000);
        array.add(vo);
